...
{
    /**
     * Get active service flyers for clients
     */
    public function index(Request $request)
    {
        try {
            ...
            Log::error('Failed to retrieve client service flyers', [
                'error' => $e->getMessage(),
    ...
    /**
     * Get a specific service flyer for client
     */
    public function show($uuid)
    {
        try {
            ...
            Log::error('Failed to retrieve client service flyer', [
                'uuid' => $uuid,
                'error' => $e->getMessage()
            ]);
